...
@interface PlaylistTableViewController () <NSFetchedResultsControllerDelegate>
...
- (void)actionAddNewPlaylist:(UIBarButtonItem*)sender {
                                                 ...
                                                 handler:^(UIAlertAction *action)
    {
        ...
        Playlist* playlist = [NSEntityDescription insertNewObjectForEntityForName:@"BYPlaylist"
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"showPlaylistSongList"]) {
        ...
        Playlist* selectedPlaylist = [self.fetchResultController.fetchedObjects objectAtIndex:index];
        
        SongsListTableViewController* destVC = segue.destinationViewController;
...
- (void)deletePlaylistAtIndexPath:(NSIndexPath*)indexPath {
    ...
    Playlist* playlist = [self.fetchResultController.fetchedObjects objectAtIndex:indexPath.row];
...
- (void)createPlaylistForCachedSongs {
    ...
    if (error) {
        ...
        Playlist* playlistCachedSongs = [NSEntityDescription insertNewObjectForEntityForName:@"BYPlaylist" inManagedObjectContext:moc];
